...
namespace SVMClient
{
    public partial class Form1 : Form
    {
        ...
        {
            string path = Path.GetDirectoryName(PathToUnknownData) + Path.GetFileNameWithoutExtension(PathToUnknownData) + "_Converted_SVM_" + WeightValueBox.Text + ".asc";
            svmtester.SaveParameter(path);
        }

        private void TransformType2Btn_Click(object sender, EventArgs e)
        {
            svmtester.ConvertInputParams_2(WeightController.Value);
