...
namespace cBitmap
{
    ...
    public class cCreateBitmapFrom3DPoint
    {
        ...
        #region コンストラクタ
        public cCreateBitmapFrom3DPoint()
        {
        }
        ...
        public cCreateBitmapFrom3DPoint(cPointData PointData, double Ratio)
            : this(PointData, DrawType.SetPixel,Ratio)
        {
        ...
        public cCreateBitmapFrom3DPoint(cPointData PointData, DrawType DrawType ,double Ratio)
        {
            dRatio = Ratio;
            icpdPoint = new cPointData(PointData);
            switch (DrawType)
